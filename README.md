...
Alternatively, you can set the `OPENAI_API_KEY` environment variable in an `.env.backend` file at the root of the project. When using Docker Compose, the environment variables will be automatically loaded from this file.
